...
[![npm (scoped)](https://img.shields.io/npm/v/@deriv/deriv-charts.svg)](https://www.npmjs.com/package/@deriv/deriv-charts) ![node](https://img.shields.io/badge/node-%3E%3D12.3.0-blue.svg) [![Build Status](https://travis-ci.org/binary-com/SmartCharts.svg?branch=master)](https://travis-ci.org/binary-com/SmartCharts)
...
| handlePOCResponse              | SmartCharts will use this callback to send handler to get proposal_open_contract response data. It accepts 1 param which is a callback that accepts response data, return value is void: `(handler: (response: PriceProposalOpenContractsResponse) => void) => void`. Defaults to `undefined`                                                                                                                                                                                                                                                   |
