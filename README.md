...
| handlePOCResponse         | SmartCharts will use this callback to send handler to get proposal_open_contract response data. It accepts 1 param which is a callback that accepts the response data, return value is void: `(handler: (contract_info: ProposalOpenContract) => void) => void`. Defaults to `undefined`                                                                                                                                                                                                                                                   |
