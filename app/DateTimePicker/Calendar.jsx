...
class Calendar extends React.PureComponent {
    ...
    navigators = {
        nextMonth: () => {
            this.navigateTo(1, 'months', true);
        },
        previousMonth: () => {
            this.navigateTo(1, 'months', false);
        },
        nextYear: () => {
            this.navigateTo(1, 'years', true);
        },
        previousYear: () => {
            this.navigateTo(1, 'years', false);
        },
        nextDecade: () => {
            this.navigateTo(10, 'years', true);
        },
        previousDecade: () => {
            this.navigateTo(10, 'years', false);
        },
        nextCentury: () => {
            this.navigateTo(100, 'years', true);
        },
        previousCentury: () => {
            this.navigateTo(100, 'years', false);
        },
    };
    ...
    panelSelectors = {
        date: (e, is_disabled) => {
            this.updateSelectedDate(e, is_disabled);
        },
        month: e => {
    ...
    calendarViews = {
        ...
        month: () => {
            this.setState({ calendar_view: 'month' });
        },
        year: () => {
            this.setState({ calendar_view: 'year' });
        },
        decade: () => {
            this.setState({ calendar_view: 'decade' });
        },
    };
    constructor(props) {
        super(props);
    ...
    navigateTo = (value, unit, is_add) => {
        ...
        let new_date = moment
            .utc(this.state.calendar_date, date_format)
    ...
    updateSelected = (e, type) => {
        ...
        const date = moment
            .utc(calendar_date, this.props.date_format)
        ...
        return (
            <div id={id} className='calendar' value={selected_date}>
                ...
                <CalendarPanel
                    ...
                    calendar_view={calendar_view}
                />
                <CalendarFooter footer={footer} onClick={this.setToday} has_today_btn={has_today_btn} />
            </div>
        );
    }
}
