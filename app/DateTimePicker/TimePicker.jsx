        ...
        if (is_enabled) {
            ...
            if ((type === 'h' && value !== prev_hour) || (type === 'm' && value !== prev_minute)) {
                ...
                let desire_time = start_moment_clone
                    .hour(type === 'h' ? value : prev_hour)
                    .minute(type === 'm' ? value : prev_minute);
                            ...
                            {this.hours.map((h, key) => {
                                ...
                                return (
                                    <div
                                        ...
                                        key={key}
                                        onClick={() => {
                                            this.selectOption('h', h, is_enabled);
                                        }}
                                    >
                                        {h}
                                    </div>
                            ...
                            {this.minutes.map((mm, key) => {
                                ...
                                return (
                                    <div
                                        ...
                                        key={key}
                                        onClick={() => {
                                            this.selectOption('m', mm, is_enabled);
                                        }}
                                    >
                                        {mm}
                                    </div>
...
class TimePicker extends React.PureComponent {
    ...
    render() {
        ...
        const { is_nativepicker, name, is_align_right, placeholder, start_date, sessions } = this.props;
        const { value } = this.state;
        return (
            <div
                ref={this.saveRef}
                className={`${prefix_class}${this.props.padding ? ' padding' : ''}${
                    this.state.is_open ? ' active' : ''
                }`}
            >
                {is_nativepicker ? (
                    <input
