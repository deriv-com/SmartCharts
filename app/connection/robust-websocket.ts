...
(function (factory, global) {
    ...
    var RobustWebSocket = function (this: any, url: any, protocols: any, userOptions: any) {
        let realWs = { close() { } }, connectTimeout: any, self = this, attempts = 0, reconnects = -1, reconnectWhenOnlineAgain = false, explicitlyClosed = false, pendingReconnect: any, opts = Object.assign({}, (RobustWebSocket as any).defaultOptions, typeof userOptions === 'function' ? { shouldReconnect: userOptions } : userOptions);
        ...
        self.open = function () {
            if ((realWs as any).readyState !== WebSocket.OPEN && (realWs as any).readyState !== WebSocket.CONNECTING) {
                clearPendingReconnectIfNeeded();
                reconnectWhenOnlineAgain = false;
