            ...
            <Menu.Title>
                <div className="bt-priod">
                    <span className="ic-priod">
                        <span className="interval_display">
                            {interval_display}
                        </span>
                        <span className="unit_display">
                            {timeUnit_display}
                        </span>
                    </span>
                    <br />
                    <span className="ic-subtitle">
                        {t.translate('Interval')}
                    </span>
                </div>
            </Menu.Title>
            <Menu.Body>
                ...
                <div className="cq-interval">
                    <div className="timeUnit">
                        <span className={timeUnit === 'tick' ? 'selected' : ''}>
                            {t.translate('Tick')}
                        </span>
                        <span className={timeUnit === 'minute' ? 'selected' : ''}>
                            {t.translate('Minute')}
                        </span>
                        <span className={timeUnit === 'hour' ? 'selected' : ''}>
                            {t.translate('Hour')}
                        </span>
                        <span className={timeUnit === 'day' ? 'selected' : ''}>
                            {t.translate('Day')}
                        </span>
                    </div>
