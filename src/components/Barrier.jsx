...
Barrier.propTypes = {
    ...
    HighPriceLine: PropTypes.any.isRequired,
    LowPriceLine: PropTypes.any.isRequired,
    AboveShade: PropTypes.any.isRequired,
    BetweenShade: PropTypes.any.isRequired,
    BelowShade: PropTypes.any.isRequired,
